...
public class Robot extends TimedRobot {
  ...
  public Robot() {
    ...
    leftLeader = new SparkMax(DriveConstants.kFrontLeftDrivingCanId, MotorType.kBrushless);
    leftFollower = new SparkMax(DriveConstants.kRearLeftDrivingCanId, MotorType.kBrushless);
    rightLeader = new SparkMax(DriveConstants.kFrontRightDrivingCanId, MotorType.kBrushless);
    rightFollower = new SparkMax(DriveConstants.kRearRightDrivingCanId, MotorType.kBrushless);
